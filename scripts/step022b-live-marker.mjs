...
const CONTRACT_URL = new URL("../config/step022b-live-marker-contract.json", import.meta.url);
export async function loadStep022bLiveMarkerContract() {
  ...
  if (!contract || typeof contract !== "object" || !contract.fields || typeof contract.fields !== "object") {
    throw new Error("OPENRILL_STEP022B_LIVE_MARKER_CONTRACT_INVALID");
  }
  return contract;
}
export function renderStep022bLiveMarker(contract, { passed, total, state }) {
