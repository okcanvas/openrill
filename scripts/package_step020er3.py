...
STEP="STEP020ER3_WINDOWS_PYTHON_LIVE_MARKER_VALIDATOR_ENTRYPOINT_CLOSURE"; VERSION="0.20.8-step020er3"
...
def main():
    ...
    digest=hashlib.sha256(out.read_bytes()).hexdigest(); print(f"OPENRILL_STEP020ER3_PACKAGE_PASS step={STEP} version={VERSION} files={len(files)} sha256={digest}")
    return 0
