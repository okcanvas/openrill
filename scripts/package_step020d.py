...
STEP="STEP020D_TASK_AND_TASK_FLOW_RECONCILIATION_LOST_AND_RETENTION_FOUNDATION"; VERSION="0.20.4-step020d"
...
def main():
    ...
    digest=hashlib.sha256(out.read_bytes()).hexdigest(); print(f"OPENRILL_STEP020D_PACKAGE_PASS step={STEP} version={VERSION} files={len(files)} sha256={digest}")
    return 0
