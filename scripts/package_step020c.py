...
STEP="STEP020C_BOUND_TASK_FLOW_CONTROLLER_RUNTIME_AND_ATOMIC_CHILD_TASK_ADMISSION"; VERSION="0.20.3-step020c"
...
def main():
    ...
    digest=hashlib.sha256(out.read_bytes()).hexdigest(); print(f"OPENRILL_STEP020C_PACKAGE_PASS step={STEP} version={VERSION} files={len(files)} sha256={digest}")
    return 0
