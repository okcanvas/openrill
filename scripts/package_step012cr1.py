...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP012CR1 source ZIP")
    ...
    print(f"OPENRILL_STEP012CR1_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
