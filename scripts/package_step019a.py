...
STEP="STEP019A_DURABLE_GOAL_PLAN_AND_LONG_RUNNING_TASK_STATE"; VERSION="0.19.0-step019a"
...
def main():
    ...
    digest=hashlib.sha256(out.read_bytes()).hexdigest(); print(f"OPENRILL_STEP019A_PACKAGE_PASS step={STEP} version={VERSION} files={len(files)} sha256={digest}"); return 0
