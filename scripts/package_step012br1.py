...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP012BR1 source ZIP")
    ...
    print(f"OPENRILL_STEP012BR1_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
