...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP016AR1 source ZIP")
    ...
    print(f"OPENRILL_STEP016AR1_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
