...
const CONTRACT_URL = new URL("../config/step021br2-live-marker-contract.json", import.meta.url);
export async function loadStep021br2LiveMarkerContract() {
  ...
  if (!contract || typeof contract !== "object" || !contract.fields || typeof contract.fields !== "object") {
    throw new Error("OPENRILL_STEP021BR2_LIVE_MARKER_CONTRACT_INVALID");
  }
  return contract;
}
export function renderStep021br2LiveMarker(contract, { passed, total, state }) {
