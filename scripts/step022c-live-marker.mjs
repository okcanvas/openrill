...
const CONTRACT_URL = new URL("../config/step022c-live-marker-contract.json", import.meta.url);
export async function loadStep022cLiveMarkerContract() {
  ...
  if (!contract || typeof contract !== "object" || !contract.fields || typeof contract.fields !== "object") {
    throw new Error("OPENRILL_STEP022C_LIVE_MARKER_CONTRACT_INVALID");
  }
  return contract;
}
export function renderStep022cLiveMarker(contract, { passed, total, state }) {
