...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP011R6 source ZIP")
    ...
    print(f"OPENRILL_STEP011R6_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
