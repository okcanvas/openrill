...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP003A source ZIP")
...
def main() -> int:
    ...
    print(f"OPENRILL_STEP003A_PACKAGE_PASS files={len(candidates)} sha256={digest}")
    return 0
