...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP012DR2 source ZIP")
    ...
    print(f"OPENRILL_STEP012DR2_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
