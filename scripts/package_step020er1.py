...
STEP="STEP020ER1_WINDOWS_LOCAL_PROTOCOL_RESTART_CONNECT_RETRY_CLOSURE"; VERSION="0.20.6-step020er1"
...
def main():
    ...
    digest=hashlib.sha256(out.read_bytes()).hexdigest(); print(f"OPENRILL_STEP020ER1_PACKAGE_PASS step={STEP} version={VERSION} files={len(files)} sha256={digest}")
    return 0
