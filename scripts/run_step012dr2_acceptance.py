...
STEP = "STEP012DR2_VUE_VENDOR_BUILD_AND_STATIC_SERVING_ALIGNMENT"
VERSION = "0.12.8-step012dr2"
...
REPORT = resolve_acceptance_report(ROOT, ".artifacts/acceptance/STEP012DR2_ACCEPTANCE_REPORT.txt")
PACKAGED_REPORT = ROOT / "reference/validation/STEP012DR2_ACCEPTANCE_REPORT.txt"
VUE_VERSION = "3.5.40"
...
def main() -> int:
    ...
    check("step012dr2-script", scripts.get("acceptance:step012dr2") == "python scripts/run_step012dr2_acceptance.py")
    check("step012dr2-package-script", scripts.get("package:step012dr2") == "python scripts/package_step012dr2.py --output ../openrill-step012dr2-vue-vendor-build-static-serving-alignment-v1.zip")

    required = [
        "apps/agent-web/src/browser-app.ts", "apps/agent-web/public/assets/app.css",
        "scripts/run-step012d-live.mjs", "scripts/live-host-ready.mjs", "scripts/live-vue-static.mjs", "scripts/run_step012dr2_acceptance.py",
        "scripts/sh_run_step012dr2_acceptance.cmd", "scripts/sh_run_step012dr2_acceptance.sh", "scripts/package_step012dr2.py",
        ...
        "docs/plans/STEP012DR2_VUE_VENDOR_BUILD_AND_STATIC_SERVING_ALIGNMENT.md",
        ...
        "reference/validation/STEP012DR2_ACCEPTANCE_REPORT.txt",
    ...
    acceptance_source = read_utf8(ROOT / "scripts/run_step012dr2_acceptance.py")
    ...
    plan = read_utf8(ROOT / "docs/plans/STEP012DR2_VUE_VENDOR_BUILD_AND_STATIC_SERVING_ALIGNMENT.md")
    ...
    cmd_bytes = (ROOT / "scripts/sh_run_step012dr2_acceptance.cmd").read_bytes()
    check("windows-launcher-crlf", b"\r\n" in cmd_bytes and b"\n" not in cmd_bytes.replace(b"\r\n", b""))
    check("windows-launcher-root-relative", b"%~dp0.." in cmd_bytes)
    check("posix-launcher", 'cd "$SCRIPT_DIR/.."' in read_utf8(ROOT / "scripts/sh_run_step012dr2_acceptance.sh"))
    ...
    check("step012dr2-exact-vue-actual-chromium", browser_contract, browser_detail)
    ...
    lines.append(f"{STEP} checks={passed}/{len(checks)} state={state} schema={SCHEMA} host_ready=AWAITED startup=PHASED vendor_build=ALIGNED static_serving=BYTE_VERIFIED evidence=STARTUP_BOUNDED ui=AUTOMATION_CRUD_RUN_HISTORY browser=CHROMIUM mobile=PASS")
