...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP015B source ZIP")
    ...
    print(f"OPENRILL_STEP015B_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
