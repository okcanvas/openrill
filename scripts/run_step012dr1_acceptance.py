...
STEP = "STEP012DR1_HOST_READY_AND_UI_BOOTSTRAP_PHASE_ALIGNMENT"
...
REPORT = resolve_acceptance_report(ROOT, ".artifacts/acceptance/STEP012DR1_ACCEPTANCE_REPORT.txt")
PACKAGED_REPORT = ROOT / "reference/validation/STEP012DR1_ACCEPTANCE_REPORT.txt"
VUE_VERSION = "3.5.40"
...
def main() -> int:
    ...
    check("step012dr1-script", scripts.get("acceptance:step012dr1") == "python scripts/run_step012dr1_acceptance.py")
    check("step012dr1-package-script", scripts.get("package:step012dr1") == "python scripts/package_step012dr1.py --output ../openrill-step012dr1-host-ready-ui-bootstrap-phase-alignment-v1.zip")

    required = [
        "apps/agent-web/src/browser-app.ts", "apps/agent-web/public/assets/app.css",
        "scripts/run-step012d-live.mjs", "scripts/live-host-ready.mjs", "scripts/run_step012dr1_acceptance.py",
        "scripts/sh_run_step012dr1_acceptance.cmd", "scripts/sh_run_step012dr1_acceptance.sh", "scripts/package_step012dr1.py",
        "tests/unit/automation-control-ui-step012d.test.mjs", "tests/unit/live-host-ready-step012dr1.test.mjs",
        "docs/plans/STEP012DR1_HOST_READY_AND_UI_BOOTSTRAP_PHASE_ALIGNMENT.md",
        ...
        "reference/validation/STEP012DR1_ACCEPTANCE_REPORT.txt",
    ...
    plan = read_utf8(ROOT / "docs/plans/STEP012DR1_HOST_READY_AND_UI_BOOTSTRAP_PHASE_ALIGNMENT.md")
    ...
    cmd_bytes = (ROOT / "scripts/sh_run_step012dr1_acceptance.cmd").read_bytes()
    check("windows-launcher-crlf", b"\r\n" in cmd_bytes and b"\n" not in cmd_bytes.replace(b"\r\n", b""))
    check("windows-launcher-root-relative", b"%~dp0.." in cmd_bytes)
    check("posix-launcher", 'cd "$SCRIPT_DIR/.."' in read_utf8(ROOT / "scripts/sh_run_step012dr1_acceptance.sh"))
    ...
    check("step012dr1-exact-vue-actual-chromium", browser_contract, browser_detail)
    ...
    lines.append(f"{STEP} checks={passed}/{len(checks)} state={state} schema={SCHEMA} host_ready=AWAITED startup=PHASED evidence=STARTUP_BOUNDED ui=AUTOMATION_CRUD_RUN_HISTORY browser=CHROMIUM mobile=PASS")
