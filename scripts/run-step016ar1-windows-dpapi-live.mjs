...
const STEP = "STEP016AR1_WINDOWS_DPAPI_ENCODED_COMMAND_ARGUMENT_TRANSPORT_ALIGNMENT";
const VERSION = "0.16.1-step016ar1";
const SCHEMA = 15;
...
const root = await mkdtemp(join(tmpdir(), "openrill-step016ar1-live-"));
