...
STEP = "STEP014DR4_DELEGATION_DEFAULT_BUDGET_FANOUT_AND_TYPED_TOOL_ERROR_DIAGNOSTICS"
...
REPORT = resolve_acceptance_report(ROOT, ".artifacts/acceptance/STEP014DR4_ACCEPTANCE_REPORT.txt")
STAGE_LOG_DIR = REPORT.parent / "STEP014DR4_STAGES"
...
STAGES: list[tuple[str, list[str], int]] = [
    ...
    ("external-model-control-ui-live", ["node", "scripts/run-step014dr4-live.mjs"], 300),
...
def main() -> int:
    ...
    check("acceptance-script", scripts.get("acceptance:step014dr4") == "python scripts/run_step014dr4_acceptance.py")
    check("package-script", scripts.get("package:step014dr4") == "python scripts/package_step014dr4.py --output ../openrill-step014dr4-delegation-default-budget-fanout-typed-tool-error-diagnostics-v1.zip")
    ...
    required = [
        ...
        "tests/unit/delegation-control-step014d.test.mjs", "tests/unit/delegation-control-boundaries-step014d.test.mjs", "tests/unit/model-openai-responses-step014dr2.test.mjs", "tests/unit/step014dr2-boundaries.test.mjs", "tests/unit/model-openai-responses-step014dr3.test.mjs", "tests/unit/step014dr3-boundaries.test.mjs", "tests/unit/delegation-default-budget-step014dr4.test.mjs", "tests/unit/step014dr4-boundaries.test.mjs",
        "scripts/run-step014d-live.mjs", "scripts/run-step014dr1-live.mjs", "scripts/run-step014dr2-live.mjs", "scripts/run-step014dr4-live.mjs", "scripts/step014dr1-live-diagnostics.mjs",
        "scripts/check_source_root_boundary.py", "scripts/run_step014dr1_acceptance.py", "scripts/package_step014dr1.py", "scripts/run_step014dr2_acceptance.py", "scripts/package_step014dr2.py", "scripts/run_step014dr4_acceptance.py", "scripts/package_step014dr4.py",
        ...
        "docs/plans/STEP014DR4_DELEGATION_DEFAULT_BUDGET_FANOUT_AND_TYPED_TOOL_ERROR_DIAGNOSTICS.md",
        ...
        "reference/validation/STEP014DR1_LOCAL_DETERMINISTIC_VALIDATION.md", "reference/validation/STEP014DR2_LOCAL_DETERMINISTIC_VALIDATION.md", "reference/validation/STEP014DR3_LOCAL_DETERMINISTIC_VALIDATION.md", "reference/validation/STEP014DR4_LOCAL_DETERMINISTIC_VALIDATION.md",
