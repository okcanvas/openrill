...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP010R1 source ZIP")
...
def main() -> int:
    ...
    print(f"OPENRILL_STEP010R1_PACKAGE_PASS files={len(candidates)} sha256={digest}")
    return 0
