...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP012D source ZIP")
    ...
    print(f"OPENRILL_STEP012D_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
