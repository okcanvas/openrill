...
def main()->int:
 ...
 digest=hashlib.sha256(output.read_bytes()).hexdigest();print(f'OPENRILL_STEP022C_PACKAGE_PASS step={STEP} version={VERSION} files={len(files)} sha256={digest}');return 0
