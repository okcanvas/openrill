...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP003 source ZIP")
...
def main() -> int:
    ...
    print(f"OPENRILL_STEP003_PACKAGE_PASS files={len(candidates)} sha256={digest}")
    return 0
