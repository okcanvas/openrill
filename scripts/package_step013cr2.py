...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP013CR2 source ZIP")
    ...
    print(f"OPENRILL_STEP013CR2_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
