...
STEP = "STEP013AR3_ACCEPTANCE_STAGE_PROGRESS_AND_TIMEOUT_ALIGNMENT"
VERSION = "0.13.3-step013ar3"
SCHEMA = 9
...
REPORT = resolve_acceptance_report(ROOT, ".artifacts/acceptance/STEP013AR3_ACCEPTANCE_REPORT.txt")
PACKAGED_REPORT = ROOT / "reference/validation/STEP013AR3_ACCEPTANCE_REPORT.txt"
...
def main() -> int:
    ...
    check("step013ar3-script", scripts.get("acceptance:step013ar3") == "python scripts/run_step013ar3_acceptance.py")
    check("step013ar3-package-script", scripts.get("package:step013ar3") == "python scripts/package_step013ar3.py --output ../openrill-step013ar3-acceptance-stage-progress-timeout-alignment-v1.zip")
    ...
    required = [
        ...
        "docs/plans/STEP013AR3_ACCEPTANCE_STAGE_PROGRESS_AND_TIMEOUT_ALIGNMENT.md",
        ...
        "reference/validation/STEP013AR3_ACCEPTANCE_REPORT.txt",
    ...
    plan = read_utf8(ROOT / "docs/plans/STEP013AR3_ACCEPTANCE_STAGE_PROGRESS_AND_TIMEOUT_ALIGNMENT.md")
    for heading in (
    ...
    check("failure-prevention-audit", all(token in audit for token in ("single-flight", "final URL", "OR-ISSUE-081", "OR-ISSUE-083", "OR-ISSUE-085", "OR-ISSUE-086", "OR-ISSUE-087", "OR-ISSUE-088", "STEP013B")))
    ...
    cmd_bytes = (ROOT / "scripts/sh_run_step013ar3_acceptance.cmd").read_bytes()
    check("windows-launcher-crlf", b"\r\n" in cmd_bytes and b"\n" not in cmd_bytes.replace(b"\r\n", b""))
    check("windows-launcher-root-relative", b"%~dp0.." in cmd_bytes)
    check("posix-launcher", 'cd "$SCRIPT_DIR/.."' in read_utf8(ROOT / "scripts/sh_run_step013ar3_acceptance.sh"))
