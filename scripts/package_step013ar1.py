...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP013AR1 source ZIP")
    ...
    print(f"OPENRILL_STEP013AR1_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
