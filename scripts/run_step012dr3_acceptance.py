...
STEP = "STEP012DR3_BACKGROUND_PROCESS_OUTPUT_OBSERVATION_ALIGNMENT"
VERSION = "0.12.9-step012dr3"
...
REPORT = resolve_acceptance_report(ROOT, ".artifacts/acceptance/STEP012DR3_ACCEPTANCE_REPORT.txt")
PACKAGED_REPORT = ROOT / "reference/validation/STEP012DR3_ACCEPTANCE_REPORT.txt"
VUE_VERSION = "3.5.40"
...
def main() -> int:
    ...
    check("step012dr3-script", scripts.get("acceptance:step012dr3") == "python scripts/run_step012dr3_acceptance.py")
    check("step012dr3-package-script", scripts.get("package:step012dr3") == "python scripts/package_step012dr3.py --output ../openrill-step012dr3-background-process-output-observation-alignment-v1.zip")

    required = [
        "apps/agent-web/src/browser-app.ts", "apps/agent-web/public/assets/app.css",
        "scripts/run-step012d-live.mjs", "scripts/live-host-ready.mjs", "scripts/live-vue-static.mjs", "scripts/run_step012dr3_acceptance.py",
        "scripts/sh_run_step012dr3_acceptance.cmd", "scripts/sh_run_step012dr3_acceptance.sh", "scripts/package_step012dr3.py",
        ...
        "docs/plans/STEP012DR3_BACKGROUND_PROCESS_OUTPUT_OBSERVATION_ALIGNMENT.md",
        ...
        "reference/validation/STEP012DR3_ACCEPTANCE_REPORT.txt",
    ...
    acceptance_source = read_utf8(ROOT / "scripts/run_step012dr3_acceptance.py")
    ...
    plan = read_utf8(ROOT / "docs/plans/STEP012DR3_BACKGROUND_PROCESS_OUTPUT_OBSERVATION_ALIGNMENT.md")
    ...
    cmd_bytes = (ROOT / "scripts/sh_run_step012dr3_acceptance.cmd").read_bytes()
    check("windows-launcher-crlf", b"\r\n" in cmd_bytes and b"\n" not in cmd_bytes.replace(b"\r\n", b""))
    check("windows-launcher-root-relative", b"%~dp0.." in cmd_bytes)
    check("posix-launcher", 'cd "$SCRIPT_DIR/.."' in read_utf8(ROOT / "scripts/sh_run_step012dr3_acceptance.sh"))
    ...
    check("step012dr3-exact-vue-actual-chromium", browser_contract, browser_detail)
    ...
    lines.append(f"{STEP} checks={passed}/{len(checks)} state={state} schema={SCHEMA} process_output=BOUNDED_POLLING host_ready=AWAITED startup=PHASED vendor_build=ALIGNED static_serving=BYTE_VERIFIED evidence=STARTUP_BOUNDED ui=AUTOMATION_CRUD_RUN_HISTORY browser=CHROMIUM mobile=PASS")
