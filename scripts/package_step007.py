...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP007 source ZIP")
...
def main() -> int:
    ...
    print(f"OPENRILL_STEP007_PACKAGE_PASS files={len(candidates)} sha256={digest}")
    return 0
