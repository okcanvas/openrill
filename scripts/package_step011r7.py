...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP011R7 source ZIP")
    ...
    print(f"OPENRILL_STEP011R7_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
