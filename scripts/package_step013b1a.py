...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP013B1A source ZIP")
    ...
    print(f"OPENRILL_STEP013B1A_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
