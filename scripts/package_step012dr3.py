...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP012DR3 source ZIP")
    ...
    print(f"OPENRILL_STEP012DR3_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
