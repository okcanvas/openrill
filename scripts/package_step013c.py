...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP013C source ZIP")
    ...
    print(f"OPENRILL_STEP013C_PACKAGE_PASS files={len(files)} sha256={digest}")
    return 0
