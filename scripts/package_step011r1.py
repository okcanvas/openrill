...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create deterministic OpenRill STEP011R1 source ZIP")
...
def main() -> int:
    ...
    print(f"OPENRILL_STEP011R1_PACKAGE_PASS files={len(candidates)} sha256={digest}")
    return 0
