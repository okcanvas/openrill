...
Accepted baseline: `STEP020A_DURABLE_BACKGROUND_TASK_LEDGER_AND_RUNTIME_LIFECYCLE_FOUNDATION`, checks `40/40`, SHA-256 `67ac1fa4a5067ff3070f0a990bfdfd262a6d956961ebd221432cdacf567c9a7f`.

STEP020B closes only the durable Task Flow registry and controller lifecycle: revision-CAS, waiting/blocked/resume, multi-Task links, cancellation cascade, Host restart identity and read/cancel protocol. Autonomous Plan execution, automatic next-step scheduling, model control, delivery, maintenance, LOST reconciliation, retention and distribution remain deferred.

Detailed plan: `docs/plans/STEP020B_DURABLE_TASK_FLOW_REGISTRY_AND_CONTROLLER_LIFECYCLE_FOUNDATION.md`.
